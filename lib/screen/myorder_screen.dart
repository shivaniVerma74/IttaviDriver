                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Spacer(),
                                  myOrderController.orderInfo?.orderHistory[index].status == "Pending"
                                      ? Row(
                                          children: [
                                            Image.asset(
                                            ...
                                            Container(
                                              width: 60,
                                              child: Text(
                                                myOrderController.orderInfo?.orderHistory[index].status ?? "",
                                                style: TextStyle(
                                                  fontFamily:
                                      ...
                                      : myOrderController.orderInfo?.orderHistory[index].status == "Processing"
                                          ? Row(
                                              children: [
                                                Image.asset(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Expanded(
                                              child: Text(
                                                "Rs.${myOrderController.orderInfo?.orderHistory[index].total ?? ""}",
                                                maxLines: 1,
