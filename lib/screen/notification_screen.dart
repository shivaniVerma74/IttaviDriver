...
import '../helpar/fontfamily_model.dart';
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Container(
                      ...
                      child: ListTile(
                        ...
                        title: Text(
                          notificationController.notificationInfo?.notificationData[index].msg ?? "",
                          style: TextStyle(
                            fontSize: 17,
                            fontFamily: FontFamily.gilroyBold,
                            color: BlackColor,
                        ...
                        subtitle: Row(
                          children: [
                            Text(
                              notificationController.notificationInfo?.notificationData[index].date.toString().split(" ").first ?? "",
                              style: TextStyle(
                                color: greytext,
