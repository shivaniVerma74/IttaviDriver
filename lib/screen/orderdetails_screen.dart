                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            //           ),
                            //           Text(
                            //             "Rs.${myOrderController.orderInformetionInfo?.orderdata.orderProducts[myOrderController.currentIndex].productPrice}",
                            //             style: TextStyle(
                            //               fontFamily: FontFamily.gilroyBold,
                            //               fontSize: 14,
                            //               color: Colors.grey,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            OrderInfo(
                              title: "Subtotal".tr,
                              subtitle:
                                  "Rs.${myOrderController.orderInformetionInfo?.orderdata.orderSubTotal}",
                            ),
                            SizedBox(
                              height: 13,
                            ),
                            OrderInfo(
                              ...
                              subtitle:
                                  "Rs.${myOrderController.orderInformetionInfo?.orderdata.deliveryCharge}",
                            ),
                            SizedBox(
                              height: 13,
                            ),
                            OrderInfo(
                              ...
                              subtitle:
                                  "Rs.${myOrderController.orderInformetionInfo?.orderdata.storeCharge}",
                            ),
                            // SizedBox(
                            //   height: 13,
                            // ),
                            ...
                            myOrderController.orderInformetionInfo?.orderdata
                                ...
                                ? OrderInfo(
                                    ...
                                    subtitle:
                                        "Rs.${myOrderController.orderInformetionInfo?.orderdata.couponAmount}",
                                  )
                                : SizedBox(),
                            myOrderController.orderInformetionInfo?.orderdata
                                        .wallAmt !=
                            ...
                            myOrderController.orderInformetionInfo?.orderdata
                                ...
                                ? OrderInfo(
                                    ...
                                    subtitle:
                                        "Rs.${myOrderController.orderInformetionInfo?.orderdata.wallAmt}",
                                  )
                                : SizedBox(),
                            SizedBox(
                              height: 13,
                            ...
                            OrderInfo(
                              title: "Total".tr,
                              subtitle:
                                  "Rs.${myOrderController.orderInformetionInfo?.orderdata.orderTotal}",
                            ),
                            SizedBox(
                              height: 2,
                            ),
